...
var EXTRA=[{key:'brick',title:'Brick Breaker',art:'brick'},{key:'cycles',title:'Lightwall',art:'cycles'},{key:'meme',title:'Meme Maker',art:'meme'}];
var REG={};
...
var MENUS={
 ...
 go:[['Work',function(){openWork()}],['About',function(){openPage('about')}],['Tools',function(){openPage('tools')}],['Contact',function(){openPage('contact')}],null,['Brave Browser',function(){openApp('brave')}],['Music',function(){openApp('music')}],['Paint',function(){openApp('paint')}],['Brick Breaker',function(){openApp('brick')}],['Lightwall',function(){openApp('cycles')}],['Meme Maker',function(){openApp('meme')}],['Guestbook',function(){openApp('guestbook')}],['Stickies',function(){openApp('stickies')}],['Terminal',function(){openApp('terminal')}],['Trash',function(){openApp('trash')}],null,['FAQ',function(){openPage('faq')}],['Privacy policy',function(){window.open('/privacy.html','_blank','noopener')}]],
