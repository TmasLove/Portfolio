...
function openCycles(){var w=createWindow('cycles','Light Cycles',{w:940,h:760,dockKey:'cycles',appName:'Light Cycles',minW:480,minH:400});var d=document.createElement('div');d.className='game-host cyc-host';w.body.appendChild(d);var g=window.initCycles(d);w.onclose=function(){g&&g.stop()}}
